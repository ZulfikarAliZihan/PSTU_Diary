...
public class PgsList extends AppCompatActivity implements
    ...
    class ChildShortClick implements ExpandableListView.OnChildClickListener
    {
        ...
        public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
            ...
            new CustomDialog(PgsList.this, name.getText().toString(), occupation.getText().toString(), mobile.getText().toString(), email.getText().toString(), ((Parent) PgsList.this.parentList.get(groupPosition)).getName()).show();
            return false;
        }
    }
    ...
    private void loadSomeData() {
        ...
        datafromDb("pgs","পোস্টগ্রাজুয়েট স্টাডিজ");
