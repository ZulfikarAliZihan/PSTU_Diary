...
public class LibraryActivity extends AppCompatActivity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    class ChildShortClick implements ExpandableListView.OnChildClickListener
    {
        ...
        public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
            ...
            new CustomDialog(LibraryActivity.this, name.getText().toString(), occupation.getText().toString(), mobile.getText().toString(), email.getText().toString(), ((Parent) LibraryActivity.this.parentList.get(groupPosition)).getName()).show();
            return false;
        }
    }
    ...
    private void displayList() {
        ...
        myList.setOnChildClickListener(new LibraryActivity.ChildShortClick());
